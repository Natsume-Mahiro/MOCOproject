...
public class YellowUnitScript : MonoBehaviour, IDamage
{
    ...
    void Start()
    {
        ...
        if (int.TryParse(levelStr, out level))
        {
            ...
            LV = level;
            maxHP = PlayerData.Instance.YellowHitPoint * Lv;
            ATK = PlayerData.Instance.YellowAttack * Lv;
        }
        else
        {
            maxHP = PlayerData.Instance.YellowHitPoint;
            ATK = PlayerData.Instance.YellowAttack;
        }
